...
<div class="ak-container">
    ...
    <div class="week-offer">
        <section id="aptf_widget-2" class="widget widget_aptf_widget">
            <h2 class="widget-title">This Weeks Offers</h2>
            <div class="offer-wrapper aptf-template-2">
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Complete stress relief package - Massage + Sirodhara treatment - $200 (Was $240, Save $40)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Buy 5 Massage+Sirodhara Treatments Package for $900 (Save $100)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Buy 10 Massage+Sirodhara Treatments Package for $1600 (Save $400)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">5 one hour therapeutic massage - $415 (Save $35)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">5 ninety minutes therapeutic massage - $600 (Save $50)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Full Detox Package-7 days - $1000 (Save $400)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Udvartana- Herbal Paste massage by 2 therapists- $200 (save $50)</a>
                    </div>
                </div>
                <div class="single-offer-wrapper">
                    <div class="offer-content">
                        <a href="">Abhyanga- Synchronised Ayurvedic warm oil massage by 2 therapists- $150</a>
                    </div>
                </div>
            </div>
